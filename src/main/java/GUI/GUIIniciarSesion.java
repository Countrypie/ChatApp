...
public class GUIIniciarSesion extends javax.swing.JFrame {
    ...
    private CallbackCliente cliente;
    ...
    /// Código de inicio de sesión cuando se pulsa el botón
    private void BotonIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonIniciarSesionActionPerformed
        ...
        if (!"".equals(nombreUsuario) && !"".equals(contrasena)) {
            ...
            // Se invoca la función del servidor para hacer login
            try {
                ...
                TextoErrorInicioSesion.setText("Error de conexión. Intenta de nuevo.");
            }

        } else {
            TextoErrorInicioSesion.setVisible(true);
            TextoErrorInicioSesion.setText("Los campos no pueden estar vacíos.");
        }

        if (!inicioExitoso) {
            // Mostrar mensaje y limpiar campos para un nuevo intento
            JOptionPane.showMessageDialog(this, "Credenciales inválidas");
            // Limpia los campos para un nuevo intento de inicio de sesión
        ...
        this.setVisible(false); // Cierra la ventana después de un inicio exitoso
        cliente.setContrasena(CampoContrasena.getText());
    ...
    private void BotonRegistrarseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonRegistrarseActionPerformed
        ...
        if (contrasena.equals(CampoContrasena2.getText())) {
            ...
            try {
                ...
                if (usuarioActual != null) {
                    this.cliente.setUsuario(usuarioActual);
                    this.cliente.getUsuario().setUsername(nombreUsuario);
                    cliente.setUsuario(usuarioActual); // ¡Ojo con que ya esté registrado!
                    registroExitoso = true; // Se registró correctamente
                }

            } catch (RemoteException ex) {
                Logger.getLogger(GUIIniciarSesion.class.getName()).log(Level.SEVERE, null, ex);
                TextoErrorRegistrarse.setVisible(true);
                TextoErrorRegistrarse.setText("Error de conexión. Intenta de nuevo.");
            }
        ...
        if (!registroExitoso) {
            // Pausar y permitir que el usuario ingrese datos nuevamente
            // Podrías implementar un popup o algún mecanismo que detenga el flujo hasta que se intenten nuevos datos.
            // Limpia los campos para un nuevo intento
            JOptionPane.showMessageDialog(this, "Credenciales inválidas.");
            CampoNombreUsuario1.setText("");
        ...
        cliente.setContrasena(CampoContrasena1.getText());
